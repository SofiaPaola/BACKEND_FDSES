...
public class ProveedorRestController {
	...
	public ResponseEntity<?> update(@Valid @RequestBody Proveedor proveedor, BindingResult result, @PathVariable Long id) {
	 ...
	 if(proveedorActual == null) {
			...
			response.put("mensaje","Error no se pudo editar, El proveedor ID: ".concat(id.toString().concat(" No existe en la base de datos")));
			return new ResponseEntity<Map<String, Object>>(response,HttpStatus.NOT_FOUND);
		}
...
public List<Ciudad> listarCiudades() {
	return proveedorService.findAllCiudades();
}
...
@GetMapping("/proveedores/tipodocumento")
